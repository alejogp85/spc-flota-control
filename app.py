...
fig.text(0.15, 0.95, "⚠️ THRESHOLD ALERT: > 3σ", fontsize=12, color='#FF4C4C', weight='bold')
fig.text(0.15, 0.90, "✅ OPERATIONAL EFFICIENCY: 99.7% de viajes dentro del límite", fontsize=10, color='#00FF00')
fig.text(0.15, 0.85, "💰 SAVINGS OPPORTUNITY: Reducción de variabilidad detectada (P&L Protection)", fontsize=10, color='#FFD700')
